                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.985 511.985" xml:space="preserve">
                    ...
                    C6.774,187.91,0,221.44,0,255.993C0,290.553,6.774,324.085,20.125,355.645z" />
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Pokemaxi</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle ">
                            ...
                            <div>Tabla Pokemon</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="tablaPokemon.php" class="menu-link" h>
                                    <div>Ver Tabla Completa</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="añadirPokemon.php" class="menu-link">
                                    <div>Añadir Pokemon</div>
                                </a>
                            </li>
            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">pokemon /</span> Tabla </h4>

                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <h5 class="card-header">Tabla pokemon</h5>
                                    <div class="table-responsive text-nowrap">
                                        <table class="table">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                <tr>
                                                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>191</strong></td>
                                                    <td>Ekans</td>
                                                    <td>
                                                        <span>16/04/24 08:47:08</span>
                                                    </td>
                                                    <td><span class="badge bg-label-primary me-1">oscuro</span></td>
                                                    <td>
                                                        <div class="dropdown">
                                                ...
                                                <tr>
                                                    <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>192</strong></td>
                                                    <td>Hipno</td>
                                                    <td>
                                                        <span>16/04/24 08:47:08</span>
                                                    </td>
                                                    <td><span class="badge bg-label-success me-1">planta</span></td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                                <i class="bx bx-dots-vertical-rounded"></i>
                                                ...
                                                <tr>
                                                    <td><i class="fab fa-vuejs fa-lg text-success me-3"></i> <strong>193</strong></td>
                                                    <td>Girrafe</td>
                                                    <td>
                                                    ...
                                                    <td><span class="badge bg-label-info me-1">Agua</span></td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                                <i class="bx bx-dots-vertical-rounded"></i>
                                                ...
                                                <tr>
                                                    <td>
                                                        <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>Charmander</strong>
                                                    </td>
                                                    <td>Jerry Milton</td>
                                                    <td>
                                                        <span>16/04/24 08:47:08</span>
                                                    </td>
                                                    <td><span class="badge bg-label-danger me-1">Fuego</span></td>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                                <i class="bx bx-dots-vertical-rounded"></i>
