        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <!-- Content -->
                    <div class="container-fluid container-p-y border d-flex row " style="margin-top: 5%;">
                        <div class="row">
                            <!-- Order Statistics -->
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                                        <div class="card-title mb-0">
                                            <h5 class="m-0 me-2">Grafico 1</h5>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6 col-lg-6 order-1 mb-4">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="m-0 me-2">Grafico 2</h5>
                                    </div>
                            ...
                            <div class="col-12 order-2 mb-4">
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title m-0 me-2">Historial</h5>
                                    </div>
                                    <div class="card-body">
