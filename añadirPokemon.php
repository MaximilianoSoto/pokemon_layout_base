            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">pokemon /</span> Agrega un pokemon</h4>

                        <div class="row">
                            <div class="col-md-12">

                                <div class="card mb-4">
                                    <h5 class="card-header">Añadir pokemon</h5>
                                        ...
                                        <form id="formAccountSettings" method="POST" onsubmit="return false">
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input class="form-control" type="text" id="firstName" name="firstName" placeholder="pikachu" />
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="currency" class="form-label">Tipo</label>
                                                ...
                                                <div class="mb-3 col-6">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <textarea id="basic-icon-default-message" class="form-control" placeholder="Ingresa una descripcion de pokemon" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
                                                    </div>
                                                </div>
                                                <div class="mt-5 mb-3 col-6  text-end">
